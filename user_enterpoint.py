                    ...
                    while True:
                        ...
                        if user_input2.isdigit():
                            ...
                            if user_input2 >= 0 and user_input2 < selected_hostgroup.bind_hosts.all().count() :
                                ...
                                login_cmd = 'sshpass  -p {password} /usr/local/openssh7/bin/ssh {user}@{ip_addr}  -o "StrictHostKeyChecking no" -Z {md5_str}'.format(password=selected_bindhost.host_user.password,
                                                                                                                                user=selected_bindhost.host_user.username,
                                                                                                                                ip_addr=selected_bindhost.host.ip_addr, md5_str=md5_str)
